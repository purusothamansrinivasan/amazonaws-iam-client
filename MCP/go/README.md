...
This MCP (Model Content Protocol) server provides access to AWS Identity and Access Management API functionality through HTTP, HTTPS, and STDIO transport modes.
