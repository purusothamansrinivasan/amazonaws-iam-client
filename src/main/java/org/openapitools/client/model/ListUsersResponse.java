...
public class ListUsersResponse {
  ...
  public ListUsersResponse users(@javax.annotation.Nonnull List<User> users) {
    this.users = users;
    return this;
  }
  ...
  public ListUsersResponse isTruncated(@javax.annotation.Nullable Boolean isTruncated) {
  ...
  public ListUsersResponse marker(@javax.annotation.Nullable String marker) {
    this.marker = marker;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("Users", "IsTruncated", "Marker"));
