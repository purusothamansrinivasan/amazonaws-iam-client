...
public class AttachedPolicy {
  ...
  public AttachedPolicy policyName(@javax.annotation.Nullable String policyName) {
  ...
  public AttachedPolicy policyArn(@javax.annotation.Nullable String policyArn) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("PolicyName", "PolicyArn"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AttachedPolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttachedPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttachedPolicy is not found in the empty JSON string", AttachedPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttachedPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttachedPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttachedPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttachedPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttachedPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttachedPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<AttachedPolicy>() {
           @Override
           public void write(JsonWriter out, AttachedPolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttachedPolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AttachedPolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AttachedPolicy
   * @throws IOException if the JSON string is invalid with respect to AttachedPolicy
   */
  public static AttachedPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttachedPolicy.class);
  }

  /**
   * Convert an instance of AttachedPolicy to an JSON string
   *
   * @return JSON string
   */
