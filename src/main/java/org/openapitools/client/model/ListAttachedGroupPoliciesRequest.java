...
public class ListAttachedGroupPoliciesRequest {
  ...
  public ListAttachedGroupPoliciesRequest groupName(@javax.annotation.Nonnull String groupName) {
  ...
  public ListAttachedGroupPoliciesRequest pathPrefix(@javax.annotation.Nullable String pathPrefix) {
  ...
  public ListAttachedGroupPoliciesRequest marker(@javax.annotation.Nullable String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public ListAttachedGroupPoliciesRequest maxItems(@javax.annotation.Nullable Integer maxItems) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("GroupName", "PathPrefix", "Marker", "MaxItems"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAttachedGroupPoliciesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAttachedGroupPoliciesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAttachedGroupPoliciesRequest is not found in the empty JSON string", ListAttachedGroupPoliciesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAttachedGroupPoliciesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAttachedGroupPoliciesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListAttachedGroupPoliciesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAttachedGroupPoliciesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAttachedGroupPoliciesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAttachedGroupPoliciesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAttachedGroupPoliciesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAttachedGroupPoliciesRequest>() {
           @Override
           public void write(JsonWriter out, ListAttachedGroupPoliciesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAttachedGroupPoliciesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAttachedGroupPoliciesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAttachedGroupPoliciesRequest
   * @throws IOException if the JSON string is invalid with respect to ListAttachedGroupPoliciesRequest
   */
  public static ListAttachedGroupPoliciesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAttachedGroupPoliciesRequest.class);
  }

  /**
   * Convert an instance of ListAttachedGroupPoliciesRequest to an JSON string
   *
   * @return JSON string
   */
