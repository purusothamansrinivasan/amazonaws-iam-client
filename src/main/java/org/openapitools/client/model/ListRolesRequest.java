...
public class ListRolesRequest {
  ...
  public ListRolesRequest pathPrefix(@javax.annotation.Nullable String pathPrefix) {
  ...
  public ListRolesRequest marker(@javax.annotation.Nullable String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public ListRolesRequest maxItems(@javax.annotation.Nullable Integer maxItems) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListRolesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRolesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListRolesRequest is not found in the empty JSON string", ListRolesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRolesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListRolesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListRolesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListRolesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListRolesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListRolesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListRolesRequest>() {
           @Override
           public void write(JsonWriter out, ListRolesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListRolesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListRolesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListRolesRequest
   * @throws IOException if the JSON string is invalid with respect to ListRolesRequest
   */
  public static ListRolesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListRolesRequest.class);
  }

  /**
   * Convert an instance of ListRolesRequest to an JSON string
   *
   * @return JSON string
   */
