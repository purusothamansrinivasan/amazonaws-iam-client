...
public class ListRolePoliciesRequest {
  ...
  public ListRolePoliciesRequest roleName(@javax.annotation.Nonnull String roleName) {
  ...
  public ListRolePoliciesRequest marker(@javax.annotation.Nullable String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public ListRolePoliciesRequest maxItems(@javax.annotation.Nullable Integer maxItems) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListRolePoliciesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRolePoliciesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListRolePoliciesRequest is not found in the empty JSON string", ListRolePoliciesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRolePoliciesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListRolePoliciesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListRolePoliciesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListRolePoliciesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListRolePoliciesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListRolePoliciesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListRolePoliciesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListRolePoliciesRequest>() {
           @Override
           public void write(JsonWriter out, ListRolePoliciesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListRolePoliciesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListRolePoliciesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListRolePoliciesRequest
   * @throws IOException if the JSON string is invalid with respect to ListRolePoliciesRequest
   */
  public static ListRolePoliciesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListRolePoliciesRequest.class);
  }

  /**
   * Convert an instance of ListRolePoliciesRequest to an JSON string
   *
   * @return JSON string
   */
