...
public class DeletePolicyVersionRequest {
  ...
  public DeletePolicyVersionRequest policyArn(@javax.annotation.Nonnull String policyArn) {
  ...
  public DeletePolicyVersionRequest versionId(@javax.annotation.Nonnull String versionId) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePolicyVersionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePolicyVersionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePolicyVersionRequest is not found in the empty JSON string", DeletePolicyVersionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePolicyVersionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePolicyVersionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePolicyVersionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePolicyVersionRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<DeletePolicyVersionRequest>() {
           @Override
           public void write(JsonWriter out, DeletePolicyVersionRequest value) throws IOException {
